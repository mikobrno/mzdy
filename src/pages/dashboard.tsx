...
const StatsCard = React.lazy(() => import('@/components/dashboard/stats-card'))
const SVJOverviewCard = React.lazy(() => import('@/components/dashboard/svj-overview-card'))
...
export default function Dashboard() {
  ...
  return (
    <Suspense fallback={<div>Načítání komponent...</div>}>
